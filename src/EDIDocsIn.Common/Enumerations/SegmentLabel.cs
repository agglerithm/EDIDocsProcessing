...
{
    [CoverageExclude("Just like constants", "John")]
    public class SegmentLabel : EnumerationOfInteger
    {
        ...
        private SegmentLabel(string displayName, int value) : base(value, displayName)
        { 
        }
