...
using EDIDocsProcessing.Tests.UnitTests.Initech;
using EdiMessages;
...
namespace EDIDocsProcessing.Tests.UnitTests
{
    ...
    public class EDIDocsInServiceTester
    {
        ...
        public void SetUp()
        {
            ...
            _sut = new EdiDocsInWorker(_fileProcessingService.Object);
        }
        ...
        public void can_do_work()
        {
            ...
            _fileProcessingService.Setup(x => x.ProcessFiles(TransmissionPath.Initech)).Returns(createOrderMessages);
