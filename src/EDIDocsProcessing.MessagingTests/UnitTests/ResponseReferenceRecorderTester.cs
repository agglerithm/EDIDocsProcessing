...
namespace EDIDocsProcessing.Tests.UnitTests
{
    ...
    public class ResponseReferenceRecorderTester
    {
        ...
        public void can_save_outer_refs()
        {
            ...
            var lst = _recorder.MemorizeOuterReferences(segList, _controlNumber,"~",BusinessPartner.FedEx);
        ...
        public void can_save_inner_refs()
        {
            ...
            _recorder.MemorizeInnerReferences(refs, _controlNumber,BusinessPartner.FedEx);
