...
{
    public class RunnerConfigurator :                 IRunnerConfigurator         
    {                 
        ...
        /// <summary>                 
        /// Sets the display name of the service within the Service Control Manager.                 /// </summary>                 
        ...
        /// <summary>                 /// Sets the name of the service.                 /// </summary>                 /// <remarks>                 
        ...
        /// </summary>                 /// <param name="description">The description of the service.</param>                 
        ...
        {
            Console.WriteLine("Depends on Msmq.");
        ...
        {                     
            Console.WriteLine("Configuring service: " + name);
        ...
        {
            Console.WriteLine("Configuring service in isolation.");              
        ...
        public void ConfigureServiceInIsolation<TService>(string name, Action<IIsolatedServiceConfigurator<TService>> action)  
            where TService : MarshalByRefObject
        {
            Console.WriteLine("Configuring service " + name + " in isolation.");            
